...
SELECT id, email, password, full_name, created_at, updated_at FROM users WHERE email = $1 LIMIT 1
`
...
SELECT id, email, password, full_name, created_at, updated_at FROM users WHERE id = $1 LIMIT 1
`
